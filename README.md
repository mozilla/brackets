...
* `"projectDirty"` - triggered whenever the current file has been changed. It includes an `Object` with the path to the current file.
* `"projectSaved"` - triggered whenever the changes are saved to the local computer are completed.
